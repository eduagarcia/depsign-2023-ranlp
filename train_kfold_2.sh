...
OUTPUT_DIR=kfold/output/${STUDY_NAME}_oversampled
...
datalawyer_tune retrain huggingface_script \
  ...
  --overrides "{\"script_path\": \"${HYPSEARCH_DIR}/run_glue.py\", \"train_file\": \"/raid/juliana/depsign/edu/kfold/{0}/train_oversampled.csv\", \"validation_file\": \"/raid/juliana/depsign/edu/kfold/{0}/dev_data.csv\", \"test_file\": \"/raid/juliana/depsign/edu/kfold/{0}/dev_data.csv\"}" \
