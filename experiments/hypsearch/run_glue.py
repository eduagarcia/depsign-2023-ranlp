...
def main():
    ...
    def compute_metrics(p: EvalPrediction):
        ...
        for m in metric:
            ...
            r = metric[m].compute(predictions=preds, references=references, **kwargs)
            ...
            if hasattr(r[m], '__iter__'):
                ...
                avg = "macro"
                result[f"{m} ({avg})"] = metric[m].compute(predictions=preds, references=references, average=avg)[m]
            else:
                result.update(r)
