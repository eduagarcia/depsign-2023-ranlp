...
STUDY_NAME=deberta-mental-health-v3
...
STUDY_NAME=deberta-large-v3-maxlen
OUTPUT_DIR=kfold/output/${STUDY_NAME}
export WANDB_TAGS=${STUDY_NAME}
...
STUDY_NAME=roberta-mental-health-v3-maxlen
OUTPUT_DIR=kfold/output/${STUDY_NAME}
export WANDB_TAGS=${STUDY_NAME}

export batch_size=8
export num_gradient_accumulation_steps=1
