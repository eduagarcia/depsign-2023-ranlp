...
CONFIG_DIR=hypsearch_configs/roberta-mental-health-v6-labelsmoothing
STUDY_NAME=roberta-mental-health-v6-labelsmoothing
OUTPUT_DIR=output/${STUDY_NAME}
#BATCH_SIZE=1
#NUM_GRADIENT_ACCUMULATION_STEPS=16
export WANDB_PROJECT="Depsign"
export WANDB_TAGS=${STUDY_NAME},head+tail,label_smoothing
