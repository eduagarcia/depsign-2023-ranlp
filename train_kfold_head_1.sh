...
export WANDB_TAGS=${STUDY_NAME},head+tail,corn

datalawyer_tune retrain huggingface_script \
  "${CONFIG_DIR}/${STUDY_NAME}/tune.yaml" \
  --overrides "{\"script_path\": \"${HYPSEARCH_DIR}/run_glue_coral.py\", \"train_file\": \"/raid/juliana/depsign/edu/kfold/{0}/train_initial.csv\", \"validation_file\": \"/raid/juliana/depsign/edu/kfold/{0}/dev_data.csv\", \"test_file\": \"/raid/juliana/depsign/edu/kfold/{0}/dev_data.csv\"}" \
